<div>
   <div>
    <!--Kpay Modal -->
<div class="modal fade" id="kpayModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Scan QR code for Kpay</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <img src="/uploads/img/kpay.jpg" width="450px" alt="">
      </div>
...
<div class="modal fade" id="waveModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Scan QR code for Wave Pay</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <img src="/uploads/img/wave1.jpg" width="450px" height="400px" alt="">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary">Ok</button>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                <hr/>
                                                <div>
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kpayModal">
                                                        KPZPay
                                                    </button>
                                                
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#waveModal">
                                                        Wave Pay
                                                    </button>
                                                </div>
...
{{-- @push('scripts')
    ...
    onClick: function()  {
      ...
      onApprove: (data, actions) => {
        ...
        Livewire.emit('transcationEmail',transaction.id);
